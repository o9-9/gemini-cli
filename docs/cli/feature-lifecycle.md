...
| **GA**         | Enabled  | (None)         | Stable features that are part of the core product. Cannot be disabled.                      |
...
When a feature is stable and ready for the next stage:
...
This stage is primarily for **Beta** and **GA** features scheduled for removal.
...
To completely remove a feature. **Alpha** features can be removed without formal
deprecation, while **Beta** and **GA** features should typically go through a
...
- [Source Code (Feature Definitions)]
...
[Source Code (Feature Definitions)]: /packages/core/src/config/features.ts
